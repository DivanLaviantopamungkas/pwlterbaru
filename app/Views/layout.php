...
<head>
    ...
    <title>Tables / Data - Muria Tani</title>
        ...
        <div class="pagetitle">
            ...
            <nav>
                ...
                <ol class="breadcrumb">
                    ...
                    if ($hlm == "Home") {
                    ?>
                        <li class="breadcrumb-item active"><a href="<?= base_url('home') ?>">Menu</a></li>
                    <?php
                    } else {
                    ?>
                        <li class="breadcrumb-item active"><a href="<?= base_url('produk') ?>">Data Produk</a></li>
                    <?php
                    }
                    ?>
                </ol>
